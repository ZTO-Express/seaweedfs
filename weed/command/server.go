...
func init() {
	...
	masterOptions.leaderLeaseTimeout = cmdServer.Flag.Duration("master.leaderLeaseTimeout", 500*time.Millisecond, "leaderLeaseTimeout is used to control how long the lease")
